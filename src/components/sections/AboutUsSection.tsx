...
const AboutUsSection: React.FC = () => {
   return (
      <section className='min-h-96 flex justify-center items-center bg-background-900'>
         <div className='
            flex flex-col justify-start items-start gap-4 lg:flex-row my-margin-2xl px-5
         '>

            {/* --- LEFT/TOP ---- */}
            <div className='max-w-xl mr-text-l'>
               <h2 className='text-xl text-text-300 font-medium'>Who are we?</h2>
               <h3 className='max-w-sm text-3xl mt-text-xxs mb-text-xs'>A group of animal lovers who believe that all animals deserve a second chance at happiness</h3>
               ...
               <button className='
                  ...
                  rounded-lg hover:bg-primary-400 transition-colors mb-margin-l
               '>Our History</button>
            </div>
